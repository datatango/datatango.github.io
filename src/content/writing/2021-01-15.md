...
date: "2021-01-15"
description: Understanding the parts of a digital file
---

I've always wondered what makes up a digital file and [Nicole Martin](https://twobitpreservation.com/) has wonderfully written a detailed post about the zeros and ones that make up a digital file.

I'll briefly lay out the keys points from the post.

## What makes a 'digital' file?

![folder structure](/public/writing/digital_file/anatomy.jpg)
